<template>
  <div class="wrapper">
    ...
    <ModalWindow v-show="isModalOpen" @close="isModalOpen = false, edit = false" @addNote="addNote" :edit="edit"
...
export default {
  ...
  data() {
    return {
      isModalOpen: false,
      notes: [
        // {id: '1', title: 'mers', text: 'привет мир', date: '09.10.23'},
        // {id: '2', title: 'tesla', text: 'привет мир', date: '09.10.23'},
        // {id: '3', title: 'audi', text: 'привет мир', date: '09.10.23'},
      ],
      editedNote: null,
      edit: false,
      searchVal: '',
